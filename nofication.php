...
<script>
    UIkit.notification({message:'<span class="nofication__iconSuccess" uk-icon="icon: check"></span> The action that you have done was a success! Well done', pos: 'top-right',status:'success',timeout:0});
</script>
